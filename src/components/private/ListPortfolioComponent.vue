          ...
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            <TransitionChild as="template" enter="transform transition ease-in-out duration-500 sm:duration-700"
              ...
              <DialogPanel class="pointer-events-auto relative w-screen max-w-md">
                ...
                <div class="rounded-l-xl flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                  <div class="relative flex-1 px-4 sm:px-6 mt-4 sm:mt-0">
                    <div
                      class="text-center px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-5">
                    ...
                    <dl class="grid gap-y-5 sm:gap-y-5 mt-5">
                      <div :class="!linkAuthor ? 'grid justify-items-center' : null">
                        <div class=" text-gray-800">
                          <div class="flex justify-between">
                            ...
                            <div v-if="btnLike" class="flex items-center space-x-1 text-blue-500 mt-2 mr-4">
                              {{ loaderLikes }}
                      ...
                      <div v-if="portfolio?.site || portfolio?.github || portfolio?.facebook || portfolio?.instagram"
                        ...
                        <div class=" space-x-4 ">
                          ...
                          <a title="Link Github" v-if="portfolio?.github" target="_blank" :href="portfolio?.github"
                          ...
                          <a title="Link Facebook" v-if="portfolio?.facebook" target="_blank"
                          ...
                          <a title="Link Instagram" v-if="portfolio?.instagram" target="_blank"
...
export default defineComponent({
  ...
  components: { lgThumbnail, lgZoom, Lightgallery, Dialog, DialogPanel, DialogTitle, TransitionChild, TransitionRoot, HeartIcon, XIcon, ExternalLinkIcon, ButtonComponent, ContentComponent },
