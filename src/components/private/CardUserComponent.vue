<template>
  ...
  <div class="sticky top-10 p-4 bg-white shadow-lg rounded-2xl w-full dark:bg-gray-800 mb-5">
    <div class="flex flex-row items-start gap-4">
      <img :src="profile.photo" class="rounded-lg w-28 h-28" />
      <div class="flex flex-col justify-between w-full h-28">
        ...
        <div class="w-full p-2 rounded-lg dark:bg-white">
          <div class="grid grid-cols-2 text-xs text-gray-400 dark:text-black">
    ...
    <p class="text-sm text-gray-500 mt-5 mb-5">
      {{ profile.bio }}
    </p>
    <div v-if="id != profile.id" class="flex items-center justify-between gap-4 mt-6 mb-6">
      <button @click="unfollowUser" v-if="isFollowingUser" type="button"
        class="w-full px-2 py-2 text-base font-bold text-white bg-indigo-500 border rounded-lg hover:bg-indigo-700 ">
        Seguindo
      </button>

      <button @click="followUser" v-else type="button"
        class="w-full px-2 py-2 text-base font-bold text-white bg-indigo-500 border rounded-lg hover:bg-indigo-700 ">
        Seguir
      </button>
    </div>
    <hr>
    <div class="flex flex-wrap justify-center gap-2 sm:gap-1 my-5">
      <a title="Numero do WhatsApp" v-if="profile?.whatsapp" target="_blank" :href="linkWhatsApp(profile?.whatsapp)"
        class="bg-green-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
      ...
      <a title="Link Instagram" v-if="profile?.instagram" target="_blank" :href="profile?.instagram"
        class="bg-red-300 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
          <path fill="#304ffe"
      ...
      <a title="Link Facebook" v-if="profile?.facebook" target="_blank" :href="profile?.facebook"
      ...
      <a title="Link Github" v-if="profile?.github" target="_blank" :href="profile?.github"
      ...
      <a title="Link Linkedin" v-if="profile?.linkedin" target="_blank" :href="profile?.linkedin"
        class="bg-blue-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
          <path fill="#0288D1"
      ...
      <a title="Link Site" v-if="profile?.site" target="_blank" :href="profile?.site"
        class="bg-gray-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
          <path fill="#ECEFF1" d="M6,10c0-2.2,1.8-4,4-4h28c2.2,0,4,1.8,4,4v28c0,2.2-1.8,4-4,4H10c-2.2,0-4-1.8-4-4V10z">
          </path>
          <path fill="#448AFF" d="M38,6H24v18h18V10C42,7.8,40.2,6,38,6z"></path>
          <path fill="#37474F" d="M6,38c0,2.2,1.8,4,4,4h14V24H6V38z"></path>
          <path fill="#B0BEC5" d="M24,24v18h14c2.2,0,4-1.8,4-4V24H24z"></path>
        </svg>
      </a>
    </div>
  </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onMounted(() => isFollowing(props.profile.id))
    return {
      isFollowing,
      isFollowingUser,
      followUser,
