<template>
  ...
  <div class="sm:col-span-3">
    <div class="max-w-lg bg-white rounded-xl dark:bg-gray-800 shadow-lg transform duration-200 easy-in-out">
      ...
      <div class="flex justify-start px-5 -mt-14 mb-3">
        <span clspanss="block relative">
          <img alt="Foto do usuário" :src="profile.photo"
      ...
      <div class="p-7">
        ...
        <p class="text-gray-400 mt-2 dark:text-gray-400">{{ profile.office }}</p>
