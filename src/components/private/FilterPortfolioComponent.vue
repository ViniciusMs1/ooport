      ...
      filters: [
        {
          ...
          options: [
            ...
            { value: 5, label: 'Empresarial' },
            { value: 6, label: 'Escolar' },
            { value: 7, label: 'Fotográfico' },
            { value: 8, label: 'Produto Digital' },
            { value: 9, label: 'Produto Físico' },
            { value: 10, label: 'Sistema Web' },
            { value: 11, label: 'Software' },
            { value: 12, label: 'Tecnologia' },
            { value: 13, label: 'Web Site' },
          ],
        }
      ]
    }
