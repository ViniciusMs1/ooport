<template>
  <section class="relative flex flex-wrap lg:h-screen lg:items-center">
    ...
    <div class="w-full px-4 py-12 lg:w-1/2 sm:px-6 lg:px-8 sm:py-16 lg:py-24">
      <div v-if="success_forgot" class="max-w-lg mx-auto text-center">
        <svg style="display:inline" class="mb-5" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="88"
          height="88" viewBox="0 0 48 48">
          <path fill="#38b47b"
        ...
        <h1 class="text-2xl font-bold sm:text-3xl">Senha alterada com sucesso!</h1>
        <p class="mt-4 text-gray-500">
          Você alterou sua senha com sucesso, vá ao login para acessar
        </p>

        <div class="mt-5">
          <p class="text-sm text-gray-500">
            <router-link class="underline font-medium text-indigo-600 hover:text-indigo-500" :to="login">
              <button type="submit"
      ...
      <div v-else>
        <div class="max-w-lg mx-auto text-center">
          <h1 class="text-2xl font-bold sm:text-3xl">Altere sua senha</h1>
          <p class="mt-4 text-gray-500">
            Informa uma nova senha de acesso
          </p>
        </div>
        <form v-on:submit.prevent="forgotPassword" class="max-w-md mx-auto mt-8 mb-0 space-y-4">
          <div>
          ...
          <div v-if="verify_password" class="mt-5 rounded border border-red-900/10 bg-red-50 p-4 text-red-700"
            role="alert">
...
import ForgotPasswordC from "../../composables/forgot-password";
export default defineComponent({
  ...
  setup(props) {
    ...
    const { ForgotPassword, verify_password, success_forgot } = ForgotPasswordC()
