        ...
        <div class="grid gap-4 mx-4 sm:grid-cols-12">
          <div class="col-span-12 sm:col-span-3">
            <div
              ...
              <h3 class="text-2xl font-semibold">{{ message }}, {{ profileData['name'] }}!</h3>
          ...
          <div class="relative col-span-12 px-4 space-y-6 sm:col-span-9">
            <div
              ...
              <div v-for="portfolio, key in profileData['portfolio']" :key="key"
              ...
              <div
                ...
                <p class="text-sm font-medium text-gray-500">{{ formatDate(profileData['created_at']) }}</p>
...
export default defineComponent({
  ...
  setup() {
    const { me, loading, profileData } = Profile()
