          ...
          <form v-on:submit.prevent="registerProfile" class="grid grid-cols-6 gap-6 mt-8">
            ...
            <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
              <button :disabled=disabledClick type="submit"
                class="inline-flex justify-center px-5 py-3 text-sm font-medium text-white bg-blue-500 rounded-lg">
                ...
                {{ disabledClick ? 'Criando conta...' : 'Criar conta' }}
              </button>
...
export default defineComponent({
  ...
  setup() {
    const { register, errors, msg, disabledClick } = Auth()
